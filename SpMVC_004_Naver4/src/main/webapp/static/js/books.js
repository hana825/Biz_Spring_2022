...
매개변수의 속성들 중에 target 속성은 가장 안쪽에 위치한 클릭된 tag에 대한 정보를 가지고 있다. 만약 클릭된 tag가 td라면 자신(td)를 감싸고 있는 가장 가까운 곳의 tr tag 정보를 요청한다. 
그리고 tr tag에서 dataisbn 값을 추출한다.  (dataset.isbn으로 추출한다)
*/
  // if(book_table){}
