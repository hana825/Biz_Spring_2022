...
<style>
	...
	form.bbs_write hw, form.bbs_write input, form.bbs_write textarea {
		width: 90%;
		margin: 5px auto;
		padding: 8px;
	}
...
<body>
	...
	accept=".jpg", accept=".png", accept=".gif" : 이미지 파일들 중에서 jpg, png, gif 확장자를 갖는 파일만
	accept="image/*" : 모든 이미지 파일
	accept="video/*" : 모든 동영상 파일
	accept="audio/*" : 모든 음성(음악) 파일
	accept="image/*, video/*, audio/*" : 이미지, 동영상, 음성(음악) 파일
	*/%>
</body>
</html>