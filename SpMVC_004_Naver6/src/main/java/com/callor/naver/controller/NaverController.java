...
import com.callor.naver.config.NaverConfigSample;
...
public class NaverController {
	...
	/*
	 * isbn 코드를 전달받아 Naver에 검색한 후 한 개의 도서 정보만 JSON type으로 받기
	 */
	@ResponseBody
	@RequestMapping(value="/{isbn}/book", method = RequestMethod.GET , produces =NaverConfigSample.APP_JSON)
